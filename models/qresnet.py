...
def QResNet18():
    return QResNet(QBasicBlock, [2, 2, 2, 2])


def QResNet34():
    return QResNet(QBasicBlock, [3, 4, 6, 3])


def QResNet50():
    return QResNet(QBottleneck, [3, 4, 6, 3])


def QResNet101():
    return QResNet(QBottleneck, [3, 4, 23, 3])


def QResNet152():
    return QResNet(QBottleneck, [3, 8, 36, 3])
